...
export default function SignupPage() {
  return (
    <div className="relative antialiased min-h-screen flex flex-col md:flex-row overflow-x-hidden">
      {/* Visual Storytelling Pane (Left side 1:1) */}
      <div className="relative w-full md:w-1/2 min-h-[409px] md:min-h-screen flex items-center justify-center p-container-padding overflow-hidden">
        {/* Background Image */}
        <div 
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent md:bg-gradient-to-l md:from-surface-container-lowest md:via-transparent z-0" />
        
        {/* Lore Text */}
        <div className="relative z-10 max-w-lg text-left self-end md:self-center pb-8 md:pb-0">
          <span className="material-symbols-outlined text-primary text-5xl mb-4 opacity-80">auto_awesome</span>
          <h1 className="font-display-lg text-display-lg text-primary-fixed drop-shadow-[0_0_12px_rgba(233,195,73,0.6)] mb-4">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-container-padding md:p-12 bg-surface-container-lowest relative">
        {/* Stone Tablet Form Container */}
        <div className="w-full max-w-md bg-surface-container border border-outline-variant/40 rounded-xl p-8 shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.05)] relative z-10">
